...
class Migration1 extends Migration { 
  ...
  Future upgrade() async {
		...
		database.createTable(SchemaTable("tblProducts", [SchemaColumn("idProduct", ManagedPropertyType.bigInteger, isPrimaryKey: true, autoincrement: true, isIndexed: false, isNullable: false, isUnique: false),SchemaColumn("nameProduct", ManagedPropertyType.string, isPrimaryKey: false, autoincrement: false, isIndexed: false, isNullable: false, isUnique: true),SchemaColumn("price", ManagedPropertyType.doublePrecision, isPrimaryKey: false, autoincrement: false, isIndexed: false, isNullable: false, isUnique: false),SchemaColumn("stock", ManagedPropertyType.integer, isPrimaryKey: false, autoincrement: false, isIndexed: false, isNullable: false, isUnique: false),SchemaColumn("discontinued", ManagedPropertyType.boolean, isPrimaryKey: false, autoincrement: false, isIndexed: false, isNullable: false, isUnique: false)]));
		database.addColumn("tblOrderDetails", SchemaColumn.relationship("idProduct", ManagedPropertyType.bigInteger, relatedTableName: "tblProducts", relatedColumnName: "idProduct", rule: DeleteRule.nullify, isNullable: true, isUnique: false));
		database.addColumn("tblOrderDetails", SchemaColumn.relationship("idOrder", ManagedPropertyType.bigInteger, relatedTableName: "tblOrders", relatedColumnName: "idOrder", rule: DeleteRule.nullify, isNullable: true, isUnique: false));
